...
// Width perfectly fits "Humanshu"
const VIEWBOX_WIDTH = 1266 
const DEFAULT_GRADIENT_X = 633
...
export function SiteFooterInteractiveLogotype() {
  ...
  // The full wordmark path for "Humanshu" 
  // The 'a' has been flattened to perfectly match the x-height of u, m, and n
  const WORDMARK_PATH = 
    // H
    "M1 1h32v256h-32Z M33 129h64v32h-64Z M97 1h32v256h-32Z " +
    // u
    "M145 97h32v128h-32Z M177 225h64v32h-64Z M241 97h32v160h-32Z " +
    // m
    "M289 97h32v160h-32Z M321 97h64v32h-64Z M385 129h32v128h-32Z M417 97h64v32h-64Z M481 129h32v128h-32Z " +
    // a (Corrected to stay flush at y=97)
    "M625 97h32v160h-32Z M561 97h64v32h-64Z M529 129h32v96h-32Z M561 225h64v32h-64Z " +
    // n
    "M673 97h32v160h-32Z M705 97h64v32h-64Z M769 129h32v128h-32Z " +
    // s
    "M817 97h128v32h-128Z M817 129h32v32h-32Z M817 161h128v32h-128Z M913 193h32v32h-32Z M817 225h128v32h-128Z " +
    // h
    "M961 1h32v256h-32Z M993 97h96v32h-96Z M1089 129h32v128h-32Z " +
    // u
    "M1137 97h32v128h-32Z M1169 225h64v32h-64Z M1233 97h32v160h-32Z"
