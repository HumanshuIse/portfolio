    ...
    <footer className="max-w-screen overflow-x-hidden px-2">
      ...
      <div className="screen-line-top mx-auto border-x border-line pt-12 md:max-w-3xl">
        ...
        <div className="flex flex-col items-center justify-center gap-2 pb-6 text-center font-mono text-[11px] text-muted-foreground sm:text-xs">
          ...
          Inspired by chanhdai.com<span>/</span>tailwindcss.com<span>/</span>ui.shadcn.com<span>/</span>chaitanyashinde.dev<span>/</span>
          ...
          <p>
            ...
            <a 
              href="https://github.com/HumanshuIse/portfolio" 
              target="_blank"
        ...
        <div className="screen-line-top screen-line-bottom flex w-full before:z-1 after:z-1">
          <div className="mx-auto flex items-center justify-center gap-3 border-x border-line bg-background px-4 py-3 sm:gap-4">
            ...
            <a 
              href="https://github.com/HumanshuIse" 
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground transition-colors hover:text-foreground" 
              aria-label="GitHub"
            ...
            <a 
              href="https://linkedin.com/in/humanshu-ise" 
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground transition-colors hover:text-foreground" 
              aria-label="LinkedIn"
            ...
            <a 
              href="https://www.instagram.com/_shlok.1745_/" 
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground transition-colors hover:text-foreground" 
            ...
            <a 
              href="https://www.youtube.com/@humanshuise" 
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground transition-colors hover:text-foreground" 
              aria-label="YouTube"
