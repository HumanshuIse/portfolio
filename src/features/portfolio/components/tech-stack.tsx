                              ...
                              {tech.iconUrl ? (
                                ...
                                <>
                                  <Image
                                    ...
                                    src={`https://assets.humanshuise.in/images/tech-stack-icons/${tech.key}-light.svg`}
                                  ...
                                  <Image
                                    ...
                                    src={`https://assets.humanshuise.in/images/tech-stack-icons/${tech.key}-dark.svg`}
                                ...
                                <Image
                                  src={`https://assets.humanshuise.in/images/tech-stack-icons/${tech.key}.svg`}
                                  alt={`${tech.title} icon`}
                                  width={48}
                                  height={48}
                                  unoptimized
